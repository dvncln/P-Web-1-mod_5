$(document).ready(function() {
  ...
  // Event Custom: Trigger custom event
  $('#contactButton').click(function() {
  ...
  // Animasi Foto: Focus, Blur, Mousemove, Click, Double Click
  ...
  // Event Select, Mouseup, Mousemove on images
